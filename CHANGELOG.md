...
- Add `ScriptBlock` logging test for Linux and macOS [(#7599)[](https](https://github.com/powershell/powershell/pull/http)://github.com/powershell/powershell/pull/7599) (#7586)
...
* Fix an issue in implicit remoting where restricted sessions couldn't use `Get-FormatData –PowerShellVersion`. [(#4222)](https://github.com/powershell/powershell/pull/4222)
...
- Fix the progress bar rendering on Unix platforms. [(#3362)[](https](https://github.com/powershell/powershell/pull/http)://github.com/powershell/powershell/pull/3362) (#3453)
