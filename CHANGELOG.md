...
- Change default of `Start-PSBuild` to include `-PSModuleRestore` [(#7881)](https://github.com/powershell/powershell/pull/7881)
...
- Add a paragraph on `files.wxs` updating [(#7695)](https://github.com/powershell/powershell/pull/7695) (Thanks @iSazonov!)
...
- Add `Microsoft.PowerShell.MarkdownRender` to `signing.xml` [(#7472)](https://github.com/powershell/powershell/pull/7472)
...
- When using PSRP, if we receive text instead of XML, output it as error to help troubleshoot [(#7168)](https://github.com/powershell/powershell/pull/7168)
...
- Add `-AllStats` Switch parameter for `Measure-Object` cmdlet [(#7220)](https://github.com/powershell/powershell/pull/7220) (Thanks @kvprasoon!)
...
- When installing using MSI, set the working directory of the shortcut to the user home directory [(#7072)](https://github.com/powershell/powershell/pull/7072)
...
- Clean up `#if SILVERLIGHT` [(#6907)](https://github.com/powershell/powershell/pull/6907) (Thanks @iSazonov!)
...
- Change packaging to support Ubuntu 17.10 and 18.04 [(#6769)](https://github.com/powershell/powershell/pull/6769)
...
- Fix `PropertyOnlyAdapter` to allow calling base methods [(#6394)](https://github.com/powershell/powershell/pull/6394)
...
- Use `TLS1.2` in `Start-PSBootStrap` without breaking `HTTPS` [(#6236)](https://github.com/powershell/powershell/pull/6236) (Thanks @markekraus!)
...
- Skip null-element check for collections with a value-type element type [(#5432)](https://github.com/powershell/powershell/pull/5432)
...
- Rename and update PowerShell `ETW` manifest to remove the Windows PowerShell dependency. [(#5360)](https://github.com/powershell/powershell/pull/5360)
...
- Fix build in VSCode and use an improved version of `tasks.json` from @rkeithhill. [(#5453)](https://github.com/powershell/powershell/pull/5453)
- Add scripts for signing packages in the release build workflow. [(#5463)](https://github.com/powershell/powershell/pull/5463)

### Documentation and Help Content

- Fix the codebase to use the consistent copyright string. [(#5210)](https://github.com/powershell/powershell/pull/5210)
- Add documentation about how to create `libpsl` and `psrp.windows` nuget packages. [(#5278)](https://github.com/powershell/powershell/pull/5278)
- Add help strings in PowerShell banner. [(#5275)](https://github.com/powershell/powershell/pull/5275) (Thanks @iSazonov!)
- Change all links in `README.md` to absolute as they are being used in other places outside of GitHub. [(#5354)](https://github.com/powershell/powershell/pull/5354)
- Update instructions to build on VSCode based on `pwsh`. [(#5368)](https://github.com/powershell/powershell/pull/5368)
- Update `FAQ.md` about how to use PowerShell Core nuget packages. [(#5366)](https://github.com/powershell/powershell/pull/5366)
- Correct the Fedora documentation [(#5384)](https://github.com/powershell/powershell/pull/5384) (Thanks @offthewoll!)
- Add instructions about how to create the `PowerShell.Core.Instrumentation` nuget package. [(#5396)](https://github.com/powershell/powershell/pull/5396)
- Updated PowerShell to use the latest help package. [(#5454)](https://github.com/powershell/powershell/pull/5454)
...
- Use simplified names for compliance folders [(#5388)](https://github.com/powershell/powershell/pull/5388)
- Add compliance label description [(#5355)](https://github.com/powershell/powershell/pull/5355)
- Set `requestedExecutionLevel` to `asInvoker` for `pwsh.exe` on Windows. [(#5285)](https://github.com/powershell/powershell/pull/5285)
- Add `HighEntropyVA` to building pwsh. [(#5455)](https://github.com/powershell/powershell/pull/5455)

## v6.0.0-beta.9 - 2017-10-24

### Breaking changes

- Fix `ValueFromRemainingArguments` to have consistent behavior between script and C# cmdlets. [(#2038)](https://github.com/powershell/powershell/pull/2038) (Thanks @dlwyatt)
- Remove parameters `-importsystemmodules` and `-psconsoleFile` from `powershell.exe`. [(#4995)](https://github.com/powershell/powershell/pull/4995)
- Removed code to show a GUI prompt for credentials as PowerShell Core prompts in console. [(#4995)](https://github.com/powershell/powershell/pull/4995)
- Remove `-ComputerName` from `Get/Set/Remove-Service`. [(#5094)](https://github.com/powershell/powershell/pull/5094)
- Rename the executable name from `powershell` to `pwsh`. [(#5101)](https://github.com/powershell/powershell/pull/5101)
- Remove `RunspaceConfiguration` support. [(#4942)](https://github.com/powershell/powershell/pull/4942)
- Remove `-ComputerName` support since .NET Core `Process.GetProcesses(computer)` returns local processes. [(#4960)](https://github.com/powershell/powershell/pull/4960)
- Make `-NoTypeInformation` the default on `Export-Csv` and `ConvertTo-Csv`. [(#5164)](https://github.com/powershell/powershell/pull/5164) (Thanks @markekraus)
- Unify cmdlets with parameter `-Encoding` to be of type `System.Text.Encoding`. [(#5080)](https://github.com/powershell/powershell/pull/5080)

### Engine updates and fixes

- Fix PowerShell to update the `PATH` environment variable only if `PATH` exists. [(#5021)](https://github.com/powershell/powershell/pull/5021)
- Enable support of folders and files with colon in name on Unix. [(#4959)](https://github.com/powershell/powershell/pull/4959)
- Fix detection of whether `-LiteralPath` was used to suppress wildcard expansion for navigation cmdlets. [(#5038)](https://github.com/powershell/powershell/pull/5038)
- Enable using filesystem from a UNC location. [(#4998)](https://github.com/powershell/powershell/pull/4998)
- Escape trailing backslash when dealing with native command arguments. [(#4965)](https://github.com/powershell/powershell/pull/4965)
- Change location of `ModuleAnalysisCache` so it isn't shared with Windows PowerShell. [(#5133)](https://github.com/powershell/powershell/pull/5133)
- Put command discovery before scripts for Unix. [(#5116)](https://github.com/powershell/powershell/pull/5116)

### General cmdlet updates and fixes

- Correct comma position in `SecureStringCommands.resx`. [(#5033)](https://github.com/powershell/powershell/pull/5033) (Thanks @markekraus)
- User Agent of Web Cmdlets now reports the OS platform [(#4937)](https://github.com/powershell/powershell/pull/4937) (Thanks @LDSpits)
- Add the positional parameter attribute to `-InputObject` for `Set-Service`. [(#5017)](https://github.com/powershell/powershell/pull/5017) (Thanks @travisty-)
- Add `ValidateNotNullOrEmpty` attribute to `-UFormat` for `Get-Date`. [(#5055)](https://github.com/powershell/powershell/pull/5055) (Thanks @DdWr)
- Add `-NoNewLine` switch for `Out-String`. [(#5056)](https://github.com/powershell/powershell/pull/5056) (Thanks @raghav710)
- Improve progress messages written by Web Cmdlets. [(#5078)](https://github.com/powershell/powershell/pull/5078) (Thanks @markekraus)
- Add verb descriptions and alias prefixes for `Get-Verb`. [(#4746)](https://github.com/powershell/powershell/pull/4746) (Thanks @Tadas)
- Fix `Get-Content -Raw` to not miss the last line feed character. [(#5076)](https://github.com/powershell/powershell/pull/5076)
- Add authentication parameters to Web Cmdlets. [(#5052)](https://github.com/powershell/powershell/pull/5052) (Thanks @markekraus)
...
- Fix `MatchInfoContext` clone implementation [(#5121)](https://github.com/powershell/powershell/pull/5121) (Thanks @dee-see)
- Exclude `PSHostProcess` cmdlets from Unix platforms. [(#5105)](https://github.com/powershell/powershell/pull/5105)
- Fix `Add-Member` to fetch resource string correctly. [(#5114)](https://github.com/powershell/powershell/pull/5114)
- Enable `Import-Module` to be case insensitive. [(#5097)](https://github.com/powershell/powershell/pull/5097)
- Add exports for `syslog` APIs in `libpsl-native`. [(#5149)](https://github.com/powershell/powershell/pull/5149)
- Fix `Get-ChildItem` to not ignore `-Depth` parameter when using with `-Include` or `-Exclude`. [(#4985)](https://github.com/powershell/powershell/pull/4985) (Thanks @Windos)
- Added properties `UserName`, `Description`, `DelayedAutoStart`, `BinaryPathName` and `StartupType` to the `ServiceController` objects returned by `Get-Service`. [(#4907)](https://github.com/powershell/powershell/pull/4907) (Thanks @joandrsn)

### Build and Packaging Improvements

- Treat `.rtf` files as binary so EOL don't get changed. [(#5020)](https://github.com/powershell/powershell/pull/5020)
- Improve the output of `tools/installpsh-osx.sh` and update Travis-CI to use Ruby 2.3.3. [(#5065)](https://github.com/powershell/powershell/pull/5065)
- Improve `Start-PSBootstrap` to locate dotnet SDK before installing it. [(#5059)](https://github.com/powershell/powershell/pull/5059) (Thanks @PetSerAl)
- Fix the prerequisite check of the MSI package. [(#5070)](https://github.com/powershell/powershell/pull/5070)
- Support creating `tar.gz` package for Linux and macOS. [(#5085)](https://github.com/powershell/powershell/pull/5085)
- Add release builds that produce symbols for compliance scans. [(#5086)](https://github.com/powershell/powershell/pull/5086)
- Update existing Docker files for the Linux package changes. [(#5102)](https://github.com/powershell/powershell/pull/5102)
- Add compiler switches and replace dangerous function with safer ones. [(#5089)](https://github.com/powershell/powershell/pull/5089)
- Add macOS launcher. [(#5138)](https://github.com/powershell/powershell/pull/5138) (Thanks @thezim)
- Replace `httpbin.org/response-headers` Tests with WebListener. [(#5058)](https://github.com/powershell/powershell/pull/5058) (Thanks @markekraus)
- Update `appimage.sh` to reflect the new name `pwsh`. [(#5172)](https://github.com/powershell/powershell/pull/5172)
- Update the man help file used in packaging. [(#5173)](https://github.com/powershell/powershell/pull/5173)
- Update to use `pwsh` in macOS launcher. [(#5174)](https://github.com/powershell/powershell/pull/5174) (Thanks @thezim)
- Add code to send web hook for Travis-CI daily build. [(#5183)](https://github.com/powershell/powershell/pull/5183)
- Add `global.json` to pick correct SDK version. [(#5118)](https://github.com/powershell/powershell/pull/5118) (Thanks @rkeithhill)
- Update packaging to only package PowerShell binaries when packaging symbols. [(#5145)](https://github.com/powershell/powershell/pull/5145)
- Update Docker files and related due to the name change. [(#5156)](https://github.com/powershell/powershell/pull/5156)

### Code Cleanup

- Clean up Json cmdlets. [(#5001)](https://github.com/powershell/powershell/pull/5001) (Thanks @iSazonov)
- Remove code guarded by `RELATIONSHIP_SUPPORTED` and `SUPPORTS_IMULTIVALUEPROPERTYCMDLETPROVIDER`, which has never been used. [(#5066)](https://github.com/powershell/powershell/pull/5066)
- Remove PSMI code that has never been used. [(#5075)](https://github.com/powershell/powershell/pull/5075)
- Remove unreachable code for `Stop-Job`. [(#5091)](https://github.com/powershell/powershell/pull/5091) (Thanks @travisty-)
- Removed font and codepage handling code that is only applicable to Windows PowerShell. [(#4995)](https://github.com/powershell/powershell/pull/4995)

### Test

- Fix a race condition between `WebListener` and Web Cmdlets tests. [(#5035)](https://github.com/powershell/powershell/pull/5035) (Thanks @markekraus)
- Add warning to `Start-PSPester` if Pester module is not found [(#5069)](https://github.com/powershell/powershell/pull/5069) (Thanks @DdWr)
- Add tests for DSC configuration compilation on Windows. [(#5011)](https://github.com/powershell/powershell/pull/5011)
- Test fixes and code coverage automation fixes. [(#5046)](https://github.com/powershell/powershell/pull/5046)

### Documentation and Help Content

- Update Pi demo instructions about installing libunwind8. [(#4974)](https://github.com/powershell/powershell/pull/4974)
- Add links on best practice guidelines in coding guideline. [(#4983)](https://github.com/powershell/powershell/pull/4983) (Thanks @iSazonov)
- Reformat command line help for `powershell -help` [(#4989)](https://github.com/powershell/powershell/pull/4989) (Thanks @iSazonov)
- Change logo in readme to current black icon. [(#5030)](https://github.com/powershell/powershell/pull/5030)
- Fix RPM package name in `README.md`. [(#5044)](https://github.com/powershell/powershell/pull/5044)
- Update `docs/building/linux.md` to reflect the current status of powershell build. [(#5068)](https://github.com/powershell/powershell/pull/5068) (Thanks @dee-see)
- Add black version of `.icns` file for macOS. [(#5073)](https://github.com/powershell/powershell/pull/5073) (Thanks @thezim)
- Update Arch Linux installation instructions. [(#5048)](https://github.com/powershell/powershell/pull/5048) (Thanks @kylesferrazza)
- Add submodule reminder to `testing-guidelines.md`. [(#5061)](https://github.com/powershell/powershell/pull/5061) (Thanks @DdWr)
- Update instructions in `docs/building/internals.md` for building from source. [(#5072)](https://github.com/powershell/powershell/pull/5072) (Thanks @kylesferrazza)
- Add UserVoice link to Issue Template. [(#5100)](https://github.com/powershell/powershell/pull/5100) (Thanks @markekraus)
- Add `Get-WebListenerUrl` Based Examples to WebListener `README.md`. [(#4981)](https://github.com/powershell/powershell/pull/4981) (Thanks @markekraus)
- Add document about how to create cmdlet with dotnet CLI. [(#5117)](https://github.com/powershell/powershell/pull/5117) (Thanks @rkeithhill)
- Update the help text for PowerShell executable with the new name `pwsh`. [(#5182)](https://github.com/powershell/powershell/pull/5182)
- Add new forward links for PowerShell 6.0.0 help content. [(#4978)](https://github.com/powershell/powershell/pull/4978)
- Fix VSCode `launch.json` to point to `pwsh`. [(#5189)](https://github.com/powershell/powershell/pull/5189)
- Add example of how to create .NET Core cmdlet with Visual Studio. [(#5096)](https://github.com/powershell/powershell/pull/5096)

## v6.0.0-beta.8 - 2017-10-05

### Breaking changes

* Changed `New-Service` to return error when given unsupported `-StartupType` and fixed `Set-Service` icon failing test. [(#4802)](https://github.com/powershell/powershell/pull/4802)
* Allow `*` to be used in registry path for `Remove-Item`. [(#4866)](https://github.com/powershell/powershell/pull/4866)
* Remove unsupported `-ShowWindow` switch from `Get-Help`. [(#4903)](https://github.com/powershell/powershell/pull/4903)
* Fix incorrect position of a parameter which resulted in the args passed as input instead of as args for `InvokeScript()`. [(#4963)](https://github.com/powershell/powershell/pull/4963)

### Engine updates and fixes

* Make calls to `void CodeMethod` work. [(#4850)](https://github.com/powershell/powershell/pull/4850) (Thanks @powercode)
* Get `PSVersion` and `GitCommitId` from the `ProductVersion` attribute of assembly [(#4863)](https://github.com/powershell/powershell/pull/4863) (Thanks @iSazonov)
* Fix `powershell -version` and built-in help for `powershell.exe` to align with other native tools. (#4958 & #4931) (Thanks @iSazonov)
* Load assemblies with `Assembly.LoadFrom` before `Assembly.Load` when the file path is given. [(#4196)](https://github.com/powershell/powershell/pull/4196)
* Add a generic file watcher function in `HelpersCommon.psm1`. [(#4775)](https://github.com/powershell/powershell/pull/4775)
* Update old links and fix broken links in `docs/host-powershell/README.md`. [(#4877)](https://github.com/powershell/powershell/pull/4877)
* Fix when importing remote modules using version filters (and added tests). [(#4900)](https://github.com/powershell/powershell/pull/4900)
* Enable transcription of native commands on non-Windows platforms. [(#4871)](https://github.com/powershell/powershell/pull/4871)
* Add a new line to `CommandNotFoundException` error string. (#4934 & #4991)
* Fix bug where PowerShell would exit with an error within an SSH remoting connection on Linux. [(#4993)](https://github.com/powershell/powershell/pull/4993)
* Fix issues with expression redirected to file. [(#4847)](https://github.com/powershell/powershell/pull/4847)

### General cmdlet updates and fixes

* Added `Remove-Service` to Management module. [(#4858)](https://github.com/powershell/powershell/pull/4858) (Thanks @joandrsn)
* Added functionality to set credentials on `Set-Service` command. [(#4844)](https://github.com/powershell/powershell/pull/4844) (Thanks @joandrsn)
* Fix `Select-String` to exclude directories (as opposed to individual files) discovered from `-Path`. [(#4829)](https://github.com/powershell/powershell/pull/4829) (Thanks @iSazonov)
* `Get-Date` now supports more argument completion scenarios by adding `ArgumentCompletionsAttribute`. [(#4835)](https://github.com/powershell/powershell/pull/4835) (Thanks @iSazonov)
* Exclude `-ComObject` parameter of `New-Object` on unsupported (currently non-Windows) platforms. [(#4922)](https://github.com/powershell/powershell/pull/4922) (Thanks @iSazonov)
* Updated default `ModuleVersion` in `New-ModuleManifest` to `0.0.1` to align with SemVer. [(#4842)](https://github.com/powershell/powershell/pull/4842) (Thanks @LDSpits)
* Add Multipart support to web cmdlets. [(#4782)](https://github.com/powershell/powershell/pull/4782) (Thanks @markekraus)
* Add `-ResponseHeadersVariable` to `Invoke-RestMethod` to enable the capture of response headers. [(#4888)](https://github.com/powershell/powershell/pull/4888) (Thanks @markekraus)
* Initialize web cmdlets headers dictionary only once. [(#4853)](https://github.com/powershell/powershell/pull/4853) (Thanks @markekraus)
* Change web cmdlets `UserAgent` from `WindowsPowerShell` to `PowerShell`. [(#4914)](https://github.com/powershell/powershell/pull/4914) (Thanks @markekraus)

### Build and Packaging Improvements

* Make the build output the WiX compilation log if it failed. [(#4831)](https://github.com/powershell/powershell/pull/4831) (Thanks @bergmeister)
* Use a simple file based check in the MSI for the VC++ 2015 redistributables. [(#4745)](https://github.com/powershell/powershell/pull/4745) (Thanks @bergmeister)
* New icon for PowerShell Core. [(#4848)](https://github.com/powershell/powershell/pull/4848)
* Build Powershell Core using the generic RID `linux-x64`. [(#4841)](https://github.com/powershell/powershell/pull/4841)
...
* Suppress the output of building test tools in `Compress-TestContent`. [(#4957)](https://github.com/powershell/powershell/pull/4957)
* Remove unnecessary error messages from output. [(#4954)](https://github.com/powershell/powershell/pull/4954)
* Update Travis CI script so that PRs can fail due to Pester tests. [(#4830)](https://github.com/powershell/powershell/pull/4830)
* Move release build definition into PowerShell. [(#4884)](https://github.com/powershell/powershell/pull/4884)
* Fix credential scan issues. (#4927 & #4935)
* Enable security flags in native compiler. [(#4933)](https://github.com/powershell/powershell/pull/4933)
* Add VS 2017 solution file for `powershell-win-core`. [(#4748)](https://github.com/powershell/powershell/pull/4748)

### Code Cleanup

* Remove remainder of `Utility.Activities` (Workflow code). [(#4880)](https://github.com/powershell/powershell/pull/4880)
* Remove `Microsoft.PowerShell.CoreCLR.AssemblyLoadContext.dll`. [(#4868)](https://github.com/powershell/powershell/pull/4868)
* Enable auto EOL on Git repo side, fix some character encoding issues. [(#4912)](https://github.com/powershell/powershell/pull/4912)
* Updated EOL for all files to be LF in the repository. (#4943 & #4956)
* Removed leading whitespace. [(#4991)](https://github.com/powershell/powershell/pull/4991)

### DSC Language

* Update version of `PSDesiredStateConfiguration` in project files to fix complication of MOF files with the `Configuration` keyword. [(#4979)](https://github.com/powershell/powershell/pull/4979)

### Test

* Replace httpbin.org tests with `WebListener`. (Thanks @markekraus)
    * headers [(#4799)](https://github.com/powershell/powershell/pull/4799)
    * user-agent [(#4798)](https://github.com/powershell/powershell/pull/4798)
    * redirect [(#4852)](https://github.com/powershell/powershell/pull/4852)
    * encoding [(#4869)](https://github.com/powershell/powershell/pull/4869)
    * delay [(#4905)](https://github.com/powershell/powershell/pull/4905)
    * gzip & enable deflate [(#4948)](https://github.com/powershell/powershell/pull/4948)
    * related changes and fixes [(#4920)](https://github.com/powershell/powershell/pull/4920)
* Port tests for constrained language mode. [(#4816)](https://github.com/powershell/powershell/pull/4816)
* Enable `Select-String` test from a network path. [(#4921)](https://github.com/powershell/powershell/pull/4921) (Thanks @iSazonov)
* Reformat `Measure-Object` test. [(#4972)](https://github.com/powershell/powershell/pull/4972) (Thanks @iSazonov)
* Mitigate intermittent failures in access denied tests. [(#4788)](https://github.com/powershell/powershell/pull/4788)
* Fix tests that incorrectly use `ShouldBeErrorId`. [(#4793)](https://github.com/powershell/powershell/pull/4793)
* Fix a test issue that causes tests to be skipped in Travis CI run [(#4891)](https://github.com/powershell/powershell/pull/4891)
* Skip web cmdlet certificate authentication tests on CentOS and Mac. [(#4822)](https://github.com/powershell/powershell/pull/4822)
* Validate product resource strings against resx files. (#4811 & #4861)
* Add source files for coverage run. [(#4925)](https://github.com/powershell/powershell/pull/4925)
* Add the UTC offset correctly in tests for CDXML cmdlets. [(#4867)](https://github.com/powershell/powershell/pull/4867)
* Be sure to change `PSDefaultParameterValue` in the global scope. (#4977 & #4892)
* Reduce output of Pester for CI. [(#4855)](https://github.com/powershell/powershell/pull/4855)
* Add tests for
    * `Get-Content` [(#4723)](https://github.com/powershell/powershell/pull/4723) (Thanks @sarithsutha)
    * Remoting and Jobs [(#4928)](https://github.com/powershell/powershell/pull/4928)
    * `Get-Help` [(#4895)](https://github.com/powershell/powershell/pull/4895)
    * `Get-Command -ShowCommandInfo` [(#4906)](https://github.com/powershell/powershell/pull/4906)
    * `Get-Content -Tail` [(#4790)](https://github.com/powershell/powershell/pull/4790)
    * `Get-Module` over remoting [(#4787)](https://github.com/powershell/powershell/pull/4787)
    * `Start/Stop/Suspend/Resume/Restart-Service` cmdlets [(#4774)](https://github.com/powershell/powershell/pull/4774)
    * WSMan Config provider tests [(#4756)](https://github.com/powershell/powershell/pull/4756)
    * CDXML CIM `DateTime` test [(#4796)](https://github.com/powershell/powershell/pull/4796)

### Documentation and Graphics

* Sort `.spelling` (Thanks @markekraus)
* Improve the guideline for performance consideration. [(#4824)](https://github.com/powershell/powershell/pull/4824)
* Add setup steps for MacOS to use PSRP over SSH. [(#4872)](https://github.com/powershell/powershell/pull/4872)
* Instructions to demo PowerShell Core on Raspbian. [(#4882)](https://github.com/powershell/powershell/pull/4882)
* Added instructions to get permission to use PowerShell image assets. [(#4938)](https://github.com/powershell/powershell/pull/4938)
* Added demo for using Windows PowerShell modules. [(#4886)](https://github.com/powershell/powershell/pull/4886)

## v6.0.0-beta.7 - 2017-09-13

### Breaking change

* Fix `Get-Content -Delimiter` to not include the delimiter in the array elements returned [(#3706)](https://github.com/powershell/powershell/pull/3706) (Thanks @mklement0)
* Rename `$IsOSX` to `$IsMacOS` [(#4757)](https://github.com/powershell/powershell/pull/4757)

### Engine updates and fixes

* Use stricter rules when unwrapping a PSObject that wraps a COM object [(#4614)](https://github.com/powershell/powershell/pull/4614)
* Remove appended Windows PowerShell `PSModulePath` on Windows. [(#4656)](https://github.com/powershell/powershell/pull/4656)
* Ensure `GetNetworkCredential()` returns null if PSCredential has null or empty user name [(#4697)](https://github.com/powershell/powershell/pull/4697)
* Push locals of automatic variables to 'DottedScopes' when dotting script cmdlets [(#4709)](https://github.com/powershell/powershell/pull/4709)
* Fix `using module` when module has non-terminating errors handled with `SilentlyContinue` [(#4711)](https://github.com/powershell/powershell/pull/4711) (Thanks @iSazonov)
* Enable use of 'Singleline,Multiline' option in split operator [(#4721)](https://github.com/powershell/powershell/pull/4721) (Thanks @iSazonov)
* Fix error message in `ValidateSetAttribute.ValidateElement()` [(#4722)](https://github.com/powershell/powershell/pull/4722) (Thanks @iSazonov)

### General cmdlet updates and fixes

* Add Meta, Charset, and Transitional parameters to `ConvertTo-HTML` [(#4184)](https://github.com/powershell/powershell/pull/4184) (Thanks @ergo3114)
* Prevent `Test-ModuleManifest` from loading unnecessary modules [(#4541)](https://github.com/powershell/powershell/pull/4541)
* Remove AlternateStream code and `-Stream` from provider cmdlets on non-Windows [(#4567)](https://github.com/powershell/powershell/pull/4567)
* Add explicit ContentType detection to `Invoke-RestMethod` [(#4692)](https://github.com/powershell/powershell/pull/4692)
* Fix an error on `Enter-PSSession` exit [(#4693)](https://github.com/powershell/powershell/pull/4693)
* Add `-WhatIf` switch to `Start-Process` cmdlet [(#4735)](https://github.com/powershell/powershell/pull/4735) (Thanks @sarithsutha)
* Remove double spaces in .cs, .ps1, and .resx files (#4741 & #4743) (Thanks @korygill)
* Replace 'Windows PowerShell' with 'PowerShell' in resx files [(#4758)](https://github.com/powershell/powershell/pull/4758) (Thanks @iSazonov)

### Build and Packaging Improvements

* Refactor MSBuild project files to get PowerShell version from git tag [(#4182)](https://github.com/powershell/powershell/pull/4182) (Thanks @iSazonov)
* Create a single package for each Windows supported architecture (x86 and amd64) [(#4540)](https://github.com/powershell/powershell/pull/4540)
* Set the default windows RID to win7-<arch> [(#4701)](https://github.com/powershell/powershell/pull/4701)
* Enable cross-compiling for Raspberry-PI arm32 [(#4742)](https://github.com/powershell/powershell/pull/4742)
* Fix macOS brew reinstall command [(#4627)](https://github.com/powershell/powershell/pull/4627) (Thanks @TheNewStellW)
* Improvements to the Travis-CI script (#4689, #4731, #4807)
* Update OpenSUSE docker image to 42.2 [(#4737)](https://github.com/powershell/powershell/pull/4737)
* Confirm `Start-PSPackage` produces a package [(#4795)](https://github.com/powershell/powershell/pull/4795)

### Code Cleanup

* Remove Workflow code [(#4777)](https://github.com/powershell/powershell/pull/4777)
* Clean up CORECLR preprocessor directives in TraceSource [(#4684)](https://github.com/powershell/powershell/pull/4684)

### Test

* Add test WebListener module and tests for Web Cmdlet Certificate Authentication [(#4622)](https://github.com/powershell/powershell/pull/4622) (Thanks @markekraus)
* Move WebCmdlets HTTPS tests to WebListener [(#4733)](https://github.com/powershell/powershell/pull/4733) (Thanks @markekraus)
* Replace httpbin.org/get tests With WebListener [(#4738)](https://github.com/powershell/powershell/pull/4738) (Thanks @markekraus)
* Use `-PassThru` on Pester tests to reliably catch failures [(#4644)](https://github.com/powershell/powershell/pull/4644)
* Display the same number of tests regardless of platform [(#4728)](https://github.com/powershell/powershell/pull/4728)
* Improve comparison of code coverage values for a file [(#4764)](https://github.com/powershell/powershell/pull/4764)
* Silence PSSessionConfiguration test warning messages in the log [(#4794)](https://github.com/powershell/powershell/pull/4794)
* Add tests for
    * `Get-Service` [(#4773)](https://github.com/powershell/powershell/pull/4773)
    * `Set-Service` and `New-Service` [(#4785)](https://github.com/powershell/powershell/pull/4785)
    * `Trace-Command` [(#4288)](https://github.com/powershell/powershell/pull/4288)
    * `StaticParameter` [(#4779)](https://github.com/powershell/powershell/pull/4779)
    * `Test-Wsman` [(#4771)](https://github.com/powershell/powershell/pull/4771)
    * `New-Object -ComObject` [(#4776)](https://github.com/powershell/powershell/pull/4776)
    * ProxyCommand APIs [(#4791)](https://github.com/powershell/powershell/pull/4791)
* Disable tests
    * 'VC++ Redistributable'(#4673 & #4729)
    * "Test 01. Standard Property test - all properties (<property>)" due to missing CsPhysicallyInstalledMemory [(#4763)](https://github.com/powershell/powershell/pull/4763)
    * `New-Service` failing test [(#4806)](https://github.com/powershell/powershell/pull/4806)

### Documentation

* Update WritingPesterTests.md to recommend ShouldBeErrorId [(#4637)](https://github.com/powershell/powershell/pull/4637)
* Clarify the Pull Request process, roles, and responsibilities [(#4710)](https://github.com/powershell/powershell/pull/4710)
* Add absolute URLs in the issue template and pull request template [(#4718)](https://github.com/powershell/powershell/pull/4718) (Thanks @chucklu)
* Add new approved Build and Deploy verbs [(#4725)](https://github.com/powershell/powershell/pull/4725)
* Update using-vscode.md to use the new exe path [(#4736)](https://github.com/powershell/powershell/pull/4736)
* Update coding guidelines to make it more concrete and useful in a review process [(#4754)](https://github.com/powershell/powershell/pull/4754)

## v6.0.0-beta.6 - 2017-08-24

### Breaking change

* Make invalid argument error messages for `-File` and `-Command` consistent and make exit codes consistent with Unix standards [(#4573)](https://github.com/powershell/powershell/pull/4573)

### Engine updates and fixes

* Make resource loading to work with PowerShell SxS installation [(#4139)](https://github.com/powershell/powershell/pull/4139)
* Add missing assemblies to TPA list to make Pwrshplughin.dll work [(#4502)](https://github.com/powershell/powershell/pull/4502)
* Make sure running `powershell` starts instance of the current version of PowerShell. [(#4481)](https://github.com/powershell/powershell/pull/4481)
* Make sure we only use Unicode output by default on Nano and IoT systems [(#4074)](https://github.com/powershell/powershell/pull/4074)
* Enable `powershell -WindowStyle` to work on Windows. [(#4573)](https://github.com/powershell/powershell/pull/4573)
* Enable enumeration of COM collections. [(#4553)](https://github.com/powershell/powershell/pull/4553)

### General cmdlet updates and fixes

* Fix Web CmdLets `-SkipHeaderValidation` to work with non-standard User-Agent headers. (#4479 & #4512) (Thanks @markekraus)
* Add Certificate authentication support for Web CmdLets. [(#4646)](https://github.com/powershell/powershell/pull/4646) (Thanks @markekraus)
* Add support for content headers to Web CmdLets. (#4494 & #4640) (Thanks @markekraus)
* Add support for converting enums to string [(#4318)](https://github.com/powershell/powershell/pull/4318) (Thanks @KirkMunro)
* Ignore casing when binding PSReadline KeyHandler functions [(#4300)](https://github.com/powershell/powershell/pull/4300) (Thanks @oising)
* Fix `Unblock-File` for the case of a read-only file. [(#4395)](https://github.com/powershell/powershell/pull/4395) (Thanks @iSazonov)
* Use supported API to set Central Access Policy ID (CAPID) in SACL. [(#4496)](https://github.com/powershell/powershell/pull/4496)
* Make `Start-Trace` support paths that require escaping in the underlying APIs [(#3863)](https://github.com/powershell/powershell/pull/3863)
* Removing `#if CORECLR` enabled, `Enable-PSRemoting` and `Disable-PSRemoting` [(#2671)](https://github.com/powershell/powershell/pull/2671)
* Enable WSManCredSSP cmdlets and add tests. [(#4336)](https://github.com/powershell/powershell/pull/4336)
* Use .NET Core's implementation for ShellExecute. [(#4523)](https://github.com/powershell/powershell/pull/4523)
* Fix SSH Remoting handling of KeyFileParameter when the path must be quoted. [(#4529)](https://github.com/powershell/powershell/pull/4529)
* Make Web CmdLets use HTML meta charset attribute value, if present [(#4338)](https://github.com/powershell/powershell/pull/4338)
* Move to .NET Core 2.0 final [(#4603)](https://github.com/powershell/powershell/pull/4603)

### Build/test and code cleanup

* Add Amazon Linux Docker image and enable related tests. [(#4393)](https://github.com/powershell/powershell/pull/4393) (Thanks @DarwinJS)
* Make MSI verify pre-requisites are installed. [(#4602)](https://github.com/powershell/powershell/pull/4602) (Thank @bergmeister)
* Fixed formatting issues in build files. [(#4630)](https://github.com/powershell/powershell/pull/4630) (Thanks @iSazonov)
* Make sure `install-powershell.sh` installs latest powershell on macOS, even if an old version is cached in brew. [(#4509)](https://github.com/powershell/powershell/pull/4509) (Thanks @richardszalay for reporting.)
* Fixes install scripts issue for macOS. [(#4631)](https://github.com/powershell/powershell/pull/4631) (Thanks @DarwinJS)
* Many stability improvements to our nightly code coverage automation. (#4313 & #4550)
* Remove hash validation from nanoserver-insider Docker file, due to frequent changes. [(#4498)](https://github.com/powershell/powershell/pull/4498)
* Update to make Travis-CI daily build badge more reliable. [(#4522)](https://github.com/powershell/powershell/pull/4522)
* Remove unused build files, build code, and product code. (#4532, #4580, #4590, #4589, #4588, #4587, #4586, #4583, #4582, #4581)
* Add additional acceptance tests for PowerShellGet. [(#4531)](https://github.com/powershell/powershell/pull/4531)
* Only publish a NuGet of the full PowerShell core package on daily builds and not merge. [(#4517)](https://github.com/powershell/powershell/pull/4517)
* Update nanoserver-insider Docker file due to breaking changes in the base image. [(#4555)](https://github.com/powershell/powershell/pull/4555)
* Cleanup engine tests [(#4551)](https://github.com/powershell/powershell/pull/4551)
* Fix intermittent failures in filesystem tests [(#4566)](https://github.com/powershell/powershell/pull/4566)
* Add tests for
    * `New-WinEvent`. [(#4384)](https://github.com/powershell/powershell/pull/4384)
    * tab completion.  [(#4560)](https://github.com/powershell/powershell/pull/4560)
    * various types. [(#4503)](https://github.com/powershell/powershell/pull/4503)
    * CDXML CmdLets. [(#4537)](https://github.com/powershell/powershell/pull/4537)
* Only allow packaging of powershell, if it was built from a repo at the root of the file system named powershell. (#4569 & #4600)
* Update `Format-Hex` test cases to use -TestCase instead of foreach loops. [(#3800)](https://github.com/powershell/powershell/pull/3800)
* Added functionality to get code coverage for a single file locally. [(#4556)](https://github.com/powershell/powershell/pull/4556)

### Documentation

* Added Ilya (@iSazonov) as a Maintainer. [(#4365)](https://github.com/powershell/powershell/pull/4365)
* Grammar fix to the Pull Request Guide. [(#4322)](https://github.com/powershell/powershell/pull/4322)
* Add homebrew for macOS to install documentation. [(#3838)](https://github.com/powershell/powershell/pull/3838)
...
* Remove the `*-Counter` cmdlets in `Microsoft.PowerShell.Diagnostics` due to the use of unsupported APIs until a better solution is found. [(#4303)](https://github.com/powershell/powershell/pull/4303)
* Remove the `Microsoft.PowerShell.LocalAccounts` due to the use of unsupported APIs until a better solution is found. [(#4302)](https://github.com/powershell/powershell/pull/4302)

### Engine updates and fixes

* Fix the issue where PowerShell Core wasn't working on Windows 7 or Windows Server 2008 R2/2012 (non-R2). [(#4463)](https://github.com/powershell/powershell/pull/4463)
* `ValidateSetAttribute` enhancement: support set values to be dynamically generated from a custom `ValidateSetValueGenerator`. [(#3784)](https://github.com/powershell/powershell/pull/3784) (Thanks to @iSazonov!)
* Disable breaking into debugger on Ctrl+Break when running non-interactively. [(#4283)](https://github.com/powershell/powershell/pull/4283) (Thanks to @mwrock!)
* Give error instead of crashing if WSMan client library is not available. [(#4387)](https://github.com/powershell/powershell/pull/4387)
* Allow passing `$true`/`$false` as a parameter to scripts using `powershell.exe -File`. [(#4178)](https://github.com/powershell/powershell/pull/4178)
* Enable `DataRow`/`DataRowView` adapters in PowerShell Core to fix an issue with `DataTable` usage. [(#4258)](https://github.com/powershell/powershell/pull/4258)
* Fix an issue where PowerShell class static methods were being shared across `Runspace`s/`SessionState`s. [(#4209)](https://github.com/powershell/powershell/pull/4209)
* Fix array expression to not return null or throw error. [(#4296)](https://github.com/powershell/powershell/pull/4296)
* Fixes a CIM deserialization bug where corrupted CIM classes were instantiating non-CIM types. [(#4234)](https://github.com/powershell/powershell/pull/4234)
* Improve error message when `HelpMessage` property of `ParameterAttribute` is set to empty string. [(#4334)](https://github.com/powershell/powershell/pull/4334)
* Make `ShellExecuteEx` run in a STA thread. [(#4362)](https://github.com/powershell/powershell/pull/4362)

### General cmdlet updates and fixes

* Add `-SkipHeaderValidation` switch to `Invoke-WebRequest` and `Invoke-RestMethod` to support adding headers without validating the header value. [(#4085)](https://github.com/powershell/powershell/pull/4085)
* Add support for `Invoke-Item -Path <folder>`. [(#4262)](https://github.com/powershell/powershell/pull/4262)
* Fix `ConvertTo-Html` output when using a single column header. [(#4276)](https://github.com/powershell/powershell/pull/4276)
* Fix output of `Length` for `FileInfo` when using `Format-List`. [(#4437)](https://github.com/powershell/powershell/pull/4437)
* Fix an issue in implicit remoting where restricted sessions couldn't use `Get-FormatData тАУPowerShellVersion`. [(#4222)](https://github.com/powershell/powershell/pull/4222)
* Fix an issue where `Register-PSSessionConfiguration` fails if `SessionConfig` folder doesn't exist. [(#4271)](https://github.com/powershell/powershell/pull/4271)

### Installer updates

* Create script to install latest PowerShell from Microsoft package repositories (or Homebrew) on non-Windows platforms. [(#3608)](https://github.com/powershell/powershell/pull/3608) (Thanks to @DarwinJS!)
* Enable MSI upgrades rather than a side-by-side install. [(#4259)](https://github.com/powershell/powershell/pull/4259)
* Add a checkbox to open PowerShell after the Windows MSI installer has finished. [(#4203)](https://github.com/powershell/powershell/pull/4203) (Thanks to @bergmeister!)
* Add Amazon Linux compatibility to `install-powershell.sh`. [(#4360)](https://github.com/powershell/powershell/pull/4360) (Thanks to @DarwinJS!)
* Add ability to package PowerShell Core as a NuGet package. [(#4363)](https://github.com/powershell/powershell/pull/4363)

### Build/test and code cleanup

* Add build check for MFC for Visual C++ during Windows builds.
  This fixes a long-standing (and very frustrating!) issue with missing build dependencies! [(#4185)](https://github.com/powershell/powershell/pull/4185) (Thanks to @KirkMunro!)
* Move building Windows PSRP binary out of `Start-PSBuild`.
  Now `Start-PSBuild` doesn't build PSRP binary on windows. Instead, we consume the PSRP binary from a NuGet package. [(#4335)](https://github.com/powershell/powershell/pull/4335)
* Add tests for built-in type accelerators. [(#4230)](https://github.com/powershell/powershell/pull/4230) (Thanks to @dchristian3188!)
* Increase code coverage of `Get-ChildItem` on file system. [(#4342)](https://github.com/powershell/powershell/pull/4342) (Thanks to @jeffbi!)
* Increase test coverage for `Rename-Item` and `Move-Item`. [(#4329)](https://github.com/powershell/powershell/pull/4329) (Thanks to @jeffbi!)
* Add test coverage for Registry provider. [(#4354)](https://github.com/powershell/powershell/pull/4354) (Thanks to @jeffbi!)
* Fix warnings and errors thrown by PSScriptAnalyzer. [(#4261)](https://github.com/powershell/powershell/pull/4261) (Thanks to @bergmeister!)
* Fix regressions that cause implicit remoting tests to fail. [(#4326)](https://github.com/powershell/powershell/pull/4326)
* Disable legacy UTC and SQM Windows telemetry by enclosing the code in '#if LEGACYTELEMETRY'. [(#4190)](https://github.com/powershell/powershell/pull/4190)
...
In the `beta.4` release, we've introduced a change to add the Windows PowerShell `PSModulePath` to the default `PSModulePath` in PowerShell Core on Windows. [(#4132)](https://github.com/powershell/powershell/pull/4132)
...
- Add Windows PowerShell `PSModulePath` by default on Windows. [(#4132)](https://github.com/powershell/powershell/pull/4132)
- Move PowerShell to `2.0.0-preview3-25426-01` and using the .NET CLI version `2.0.0-preview2-006502`. [(#4144)](https://github.com/powershell/powershell/pull/4144)
- Performance improvement in PSReadline by minimizing writing ANSI escape sequences. [(#4110)](https://github.com/powershell/powershell/pull/4110)
- Implement Unicode escape parsing so that users can use Unicode characters as arguments, strings or variable names. [(#3958)](https://github.com/powershell/powershell/pull/3958) (Thanks to @rkeithhill!)
- Script names or full paths can have commas. [(#4136)](https://github.com/powershell/powershell/pull/4136) (Thanks to @TimCurwick!)
- Added `semver` as a type accelerator for `System.Management.Automation.SemanticVersion`. [(#4142)](https://github.com/powershell/powershell/pull/4142) (Thanks to @oising!)
- Close `eventLogSession` and `EventLogReader` to unlock an ETL log. [(#4034)](https://github.com/powershell/powershell/pull/4034) (Thanks to @iSazonov!)

### General cmdlet updates and fixes

- `Move-Item` cmdlet honors `-Include`, `-Exclude`, and `-Filter` parameters. [(#3878)](https://github.com/powershell/powershell/pull/3878)
- Add a parameter to `Get-ChildItem` called `-FollowSymlink` that traverses symlinks on demand, with checks for link loops. [(#4020)](https://github.com/powershell/powershell/pull/4020)
- Change `New-ModuleManifest` encoding to UTF8NoBOM on non-Windows platforms. [(#3940)](https://github.com/powershell/powershell/pull/3940)
- `Get-AuthenticodeSignature` cmdlets can now get file signature timestamp. [(#4061)](https://github.com/powershell/powershell/pull/4061)
- Add tab completion for `Export-Counter` `-FileFormat` parameter. [(#3856)](https://github.com/powershell/powershell/pull/3856)
- Fixed `Import-Module` on non-Windows platforms so that users can import modules with `NestedModules` and `RootModules`. [(#4010)](https://github.com/powershell/powershell/pull/4010)
- Close `FileStream` opened by `Get-FileHash`. [(#4175)](https://github.com/powershell/powershell/pull/4175) (Thanks to @rkeithhill!)

### Remoting

- Fixed PowerShell not responding when the SSH client abruptly terminates. [(#4123)](https://github.com/powershell/powershell/pull/4123)

### Documentation

- Added recommended settings for VS Code. [(#4054)](https://github.com/powershell/powershell/pull/4054) (Thanks to @iSazonov!)
...
- Remove the `BuildVersion` property from `$PSVersionTable`.
 ...
 [(#3877)](https://github.com/powershell/powershell/pull/3877) (Thanks to @iSazonov!)
...
- Remove `ClrVersion` property from `$PSVersionTable`.
 ...
 [(#4027)](https://github.com/powershell/powershell/pull/4027)
...
- Add support to probe and load assemblies from GAC on Windows platform.
 ...
 Even if the module isn't owned by the PowerShell Team, please tell us what works and what doesn't by leaving a comment in [issue #4062][issue-4062]! [(#3981)](https://github.com/powershell/powershell/pull/3981)
- Enhance type inference in tab completion based on runtime variable values. [(#2744)](https://github.com/powershell/powershell/pull/2744) (Thanks to @powercode!)
...
- Add `GitCommitId` to PowerShell Core banner.
 Now you don't have to run `$PSVersionTable` as soon as you start PowerShell to get the version! [(#3916)](https://github.com/powershell/powershell/pull/3916) (Thanks to @iSazonov!)
- Fix a bug in tab completion to make `native.exe --<tab>` call into native completer. [(#3633)](https://github.com/powershell/powershell/pull/3633) (Thanks to @powercode!)
- Fix PowerShell Core to allow use of long paths that are more than 260 characters. [(#3960)](https://github.com/powershell/powershell/pull/3960)
- Fix ConsoleHost to honour `NoEcho` on Unix platforms. [(#3801)](https://github.com/powershell/powershell/pull/3801)
- Fix transcription to not stop when a Runspace is closed during the transcription. [(#3896)](https://github.com/powershell/powershell/pull/3896)

[issue-4062]: https://github.com/PowerShell/PowerShell/issues/4062

### General cmdlet updates and fixes

- Enable `Send-MailMessage` in PowerShell Core. [(#3869)](https://github.com/powershell/powershell/pull/3869)
- Fix `Get-Help` to support case insensitive pattern matching on Unix platforms. [(#3852)](https://github.com/powershell/powershell/pull/3852)
- Fix tab completion on `Get-Help` for `about_*` topics. [(#4014)](https://github.com/powershell/powershell/pull/4014)
- Fix PSReadline to work in Windows Server Core container image. [(#3937)](https://github.com/powershell/powershell/pull/3937)
- Fix `Import-Module` to honour `ScriptsToProcess` when `-Version` is specified. [(#3897)](https://github.com/powershell/powershell/pull/3897)
- Strip authorization header on redirects with web cmdlets. [(#3885)](https://github.com/powershell/powershell/pull/3885)
- `Start-Sleep`: add the alias `ms` to the parameter `-Milliseconds`. [(#4039)](https://github.com/powershell/powershell/pull/4039) (Thanks to @Tadas!)

### Developer experience

- Make hosting PowerShell Core in your own .NET applications much easier by refactoring PowerShell Core to use the default CoreCLR loader. [(#3903)](https://github.com/powershell/powershell/pull/3903)
- Update `Add-Type` to support `CSharpVersion7`. [(#3933)](https://github.com/powershell/powershell/pull/3933) (Thanks to @iSazonov)

## v6.0.0-beta.2 - 2017-06-01

### Support backgrounding of pipelines with ampersand (`&`) [(#3360)](https://github.com/powershell/powershell/pull/3360)
...
- Crossgen more of the .NET Core assemblies to improve PowerShell Core startup time. [(#3787)](https://github.com/powershell/powershell/pull/3787)
- Enable comparison between a `SemanticVersion` instance and a `Version` instance that is constructed only with `Major` and `Minor` version values.
  This will fix some cases where PowerShell Core was failing to import older Windows PowerShell modules. [(#3793)](https://github.com/powershell/powershell/pull/3793) (Thanks to @mklement0!)

### General cmdlet updates and fixes

- Support Link header pagination in web cmdlets [(#3828)](https://github.com/powershell/powershell/pull/3828)
...
- Update `Get-ChildItem` to be more in line with the way that the *nix `ls -R` and the Windows `DIR /S` native commands handle symbolic links to directories during a recursive search.
  Now, `Get-ChildItem` returns the symbolic links it encountered during the search, but it won't search the directories those links target. [(#3780)](https://github.com/powershell/powershell/pull/3780)
- Fix `Get-ChildItem` to continue enumeration after throwing an error in the middle of a set of items.
  This fixes some issues where inaccessible directories or files would halt execution of `Get-ChildItem`. [(#3806)](https://github.com/powershell/powershell/pull/3806)
- Fix `ConvertFrom-Json` to deserialize an array of strings from the pipeline that together construct a complete JSON string.
  This fixes some cases where newlines would break JSON parsing. [(#3823)](https://github.com/powershell/powershell/pull/3823)
- Enable `Get-TimeZone` for macOS/Linux. [(#3735)](https://github.com/powershell/powershell/pull/3735)
- Change to not expose unsupported aliases and cmdlets on macOS/Linux. [(#3595)](https://github.com/powershell/powershell/pull/3595) (Thanks to @iSazonov!)
- Fix `Invoke-Item` to accept a file path that includes spaces on macOS/Linux. [(#3850)](https://github.com/powershell/powershell/pull/3850)
- Fix an issue where PSReadline was not rendering multi-line prompts correctly on macOS/Linux. [(#3867)](https://github.com/powershell/powershell/pull/3867)
- Fix an issue where PSReadline was not working on Nano Server. [(#3815)](https://github.com/powershell/powershell/pull/3815)

## v6.0.0-beta.1 - 2017-05-08

### Move to .NET Core 2.0 (.NET Standard 2.0 support)

PowerShell Core has moved to using .NET Core 2.0 so that we can leverage all the benefits of .NET Standard 2.0. [(#3556)](https://github.com/powershell/powershell/pull/3556)
...
- For the first beta of PowerShell Core 6.0, telemetry has been to the console host to report two values [(#3620)](https://github.com/powershell/powershell/pull/3620):
...
- Add support for native command globbing on Unix platforms. [(#3643)](https://github.com/powershell/powershell/pull/3643)
    - This means you can now use wildcards with native binaries/commands (e.g. `ls *.txt`).
- Fix PowerShell Core to find help content from `$PSHome` instead of the Windows PowerShell base directory. [(#3528)](https://github.com/powershell/powershell/pull/3528)
    - This should fix issues where about_* topics couldn't be found on Unix platforms.
- Add the `OS` entry to `$PSVersionTable`. [(#3654)](https://github.com/powershell/powershell/pull/3654)
- Arrange the display of `$PSVersionTable` entries in the following way: [(#3562)](https://github.com/powershell/powershell/pull/3562) (Thanks to @iSazonov!)
    - `PSVersion`
    - `PSEdition`
    - alphabetical order for rest entries based on the keys
- Make PowerShell Core more resilient when being used with an account that doesn't have some key environment variables. [(#3437)](https://github.com/powershell/powershell/pull/3437)
- Update PowerShell Core to accept the `-i` switch to indicate an interactive shell. [(#3558)](https://github.com/powershell/powershell/pull/3558)
    - This will help when using PowerShell as a default shell on Unix platforms.
- Relax the PowerShell `SemanticVersion` constructors to not require 'minor' and 'patch' portions of a semantic version name. [(#3696)](https://github.com/powershell/powershell/pull/3696)
- Improve performance to security checks when group policies are in effect for ExecutionPolicy. [(#2588)](https://github.com/powershell/powershell/pull/2588) (Thanks to @powercode)
- Fix code in PowerShell to use `IntPtr(-1)` for `INVALID_HANDLE_VALUE` instead of `IntPtr.Zero`. [(#3544)](https://github.com/powershell/powershell/pull/3544) (Thanks to @0xfeeddeadbeef)

### General cmdlet updates and fixes

- Change the default encoding and OEM encoding used in PowerShell Core to be compatible with Windows PowerShell. [(#3467)](https://github.com/powershell/powershell/pull/3467) (Thanks to @iSazonov!)
- Fix a bug in `Import-Module` to avoid incorrect cyclic dependency detection. [(#3594)](https://github.com/powershell/powershell/pull/3594)
- Fix `New-ModuleManifest` to correctly check if a URI string is well formed. [(#3631)](https://github.com/powershell/powershell/pull/3631)

### Filesystem-specific updates and fixes

- Use operating system calls to determine whether two paths refer to the same file in file system operations. [(#3441)](https://github.com/powershell/powershell/pull/3441)
    - This will fix issues where case-sensitive file paths were being treated as case-insensitive on Unix platforms.
- Fix `New-Item` to allow creating symbolic links to file/directory targets and even a non-existent target. [(#3509)](https://github.com/powershell/powershell/pull/3509)
- Change the behavior of `Remove-Item` on a symbolic link to only removing the link itself. [(#3637)](https://github.com/powershell/powershell/pull/3637)
- Use better error message when `New-Item` fails to create a symbolic link because the specified link path points to an existing item. [(#3703)](https://github.com/powershell/powershell/pull/3703)
- Change `Get-ChildItem` to list the content of a link to a directory on Unix platforms. [(#3697)](https://github.com/powershell/powershell/pull/3697)
- Fix `Rename-Item` to allow Unix globbing patterns in paths. [(#3661)](https://github.com/powershell/powershell/pull/3661)

### Interactive fixes

- Add Hashtable tab completion for `-Property` of `Select-Object`. [(#3625)](https://github.com/powershell/powershell/pull/3625) (Thanks to @powercode)
- Fix tab completion with `@{<tab>` to avoid crash in PSReadline. [(#3626)](https://github.com/powershell/powershell/pull/3626) (Thanks to @powercode)
- Use `<id> - <name>` as `ToolTip` and `ListItemText` when tab completing process ID. [(#3664)](https://github.com/powershell/powershell/pull/3664) (Thanks to @powercode)

### Remoting fixes

- Update PowerShell SSH remoting to handle multi-line error messages from OpenSSH client. [(#3612)](https://github.com/powershell/powershell/pull/3612)
- Add `-Port` parameter to `New-PSSession` to create PowerShell SSH remote sessions on non-standard (non-22) ports. [(#3499)](https://github.com/powershell/powershell/pull/3499) (Thanks to @Lee303)

### API Updates

- Add the public property `ValidRootDrives` to `ValidateDriveAttribute` to make it easy to discover the attribute state via `ParameterMetadata` or `PSVariable` objects. [(#3510)](https://github.com/powershell/powershell/pull/3510) (Thanks to @indented-automation!)
- Improve error messages for `ValidateCountAttribute`. [(#3656)](https://github.com/powershell/powershell/pull/3656) (Thanks to @iSazonov)
- Update `ValidatePatternAttribute`, `ValidateSetAttribute` and `ValidateScriptAttribute` to allow users to more easily specify customized error messages. [(#2728)](https://github.com/powershell/powershell/pull/2728) (Thanks to @powercode)
...
- Fix a bug that caused the progress bar to drift on Unix platforms. [(#3289)](https://github.com/powershell/powershell/pull/3289)
- Improve the performance of writing progress records. [(#2822)](https://github.com/powershell/powershell/pull/2822) (Thanks to @iSazonov!)
- Fix the progress bar rendering on Unix platforms. [(#3362)[](https](https://github.com/powershell/powershell/pull/http)://github.com/powershell/powershell/pull/3362) [(#3453)](https://github.com/powershell/powershell/pull/3453)
- Reuse `ProgressRecord` in Web Cmdlets to reduce the GC overhead. [(#3411)](https://github.com/powershell/powershell/pull/3411) (Thanks to @iSazonov!)
...
- Add `-Extension` and `-LeafBase` switches to `Split-Path` so that you can split paths between the filename extension and the rest of the filename. [(#2721)](https://github.com/powershell/powershell/pull/2721) (Thanks to @powercode!)
- Implement `Format-Hex` in C# along with some behavioral changes to multiple parameters and the pipeline. [(#3320)](https://github.com/powershell/powershell/pull/3320) (Thanks to @MiaRomero!)
- Add `-NoProxy` to web cmdlets so that they ignore the system-wide proxy setting. [(#3447)](https://github.com/powershell/powershell/pull/3447) (Thanks to @TheFlyingCorpse!)
- Fix `Out-Default -Transcript` to properly revert out of the `TranscribeOnly` state, so that further output can be displayed on Console. [(#3436)](https://github.com/powershell/powershell/pull/3436) (Thanks to @PetSerAl!)
- Fix `Get-Help` to not return multiple instances of the same help file. [(#3410)](https://github.com/powershell/powershell/pull/3410)

### Interactive fixes

- Enable argument auto-completion for `-ExcludeProperty` and `-ExpandProperty` of `Select-Object`. [(#3443)](https://github.com/powershell/powershell/pull/3443) (Thanks to @iSazonov!)
- Fix a tab completion bug that prevented `Import-Module -n<tab>` from working. [(#1345)](https://github.com/powershell/powershell/pull/1345)

### Cross-platform fixes

- Ignore the `-ExecutionPolicy` switch when running PowerShell on non-Windows platforms because script signing is not currently supported. [(#3481)](https://github.com/powershell/powershell/pull/3481)
- Standardize the casing of the `PSModulePath` environment variable. [(#3255)](https://github.com/powershell/powershell/pull/3255)

### JEA fixes

- Fix the JEA transcription to include the endpoint configuration name in the transcript header. [(#2890)](https://github.com/powershell/powershell/pull/2890)
- Fix `Get-Help` in a JEA session. [(#2988)](https://github.com/powershell/powershell/pull/2988)

## v6.0.0-alpha.17 - 2017-03-08

- Update PSRP client libraries for Linux and Mac.
    - We now support customer configurations for Office 365 interaction, as well as NTLM authentication for WSMan based remoting from Linux (more information [here](https://github.com/PowerShell/psl-omi-provider/releases/tag/v1.0.0.18)). [(#3271)](https://github.com/powershell/powershell/pull/3271)
- We now support remote step-in debugging for `Invoke-Command -ComputerName`. [(#3015)](https://github.com/powershell/powershell/pull/3015)
- Use prettier formatter with `ConvertTo-Json` output. [(#2787)](https://github.com/powershell/powershell/pull/2787) (Thanks to @kittholland!)
- Port `*-CmsMessage` and `Get-PfxCertificate` cmdlets to Powershell Core. [(#3224)](https://github.com/powershell/powershell/pull/3224)
- `powershell -version` now returns version information for PowerShell Core. [(#3115)](https://github.com/powershell/powershell/pull/3115)
- Add the `-TimeOut` parameter to `Test-Connection`. [(#2492)](https://github.com/powershell/powershell/pull/2492)
- Add `ShouldProcess` support to `New-FileCatalog` and `Test-FileCatalog` (fixes `-WhatIf` and `-Confirm`). [(#3074)](https://github.com/powershell/powershell/pull/3074) (Thanks to @iSazonov!)
- Fix `Test-ModuleManifest` to normalize paths correctly before validating.
    - This fixes some problems when using `Publish-Module` on non-Windows platforms. [(#3097)](https://github.com/powershell/powershell/pull/3097)
- Remove the `AliasProperty "Count"` defined for `System.Array`.
    - This removes the extraneous `Count` property on some `ConvertFrom-Json` output. [(#3231)](https://github.com/powershell/powershell/pull/3231) (Thanks to @PetSerAl!)
- Port `Import-PowerShellDatafile` from PowerShell script to C#. [(#2750)](https://github.com/powershell/powershell/pull/2750) (Thanks to @powercode!)
- Add `-CustomMethod` parameter to web cmdlets to allow for non-standard method verbs. [(#3142)](https://github.com/powershell/powershell/pull/3142) (Thanks to @Lee303!)
- Fix web cmdlets to include the HTTP response in the exception when the response status code is not success. [(#3201)](https://github.com/powershell/powershell/pull/3201)
- Expose a process' parent process by adding the `CodeProperty "Parent"` to `System.Diagnostics.Process`. [(#2850)](https://github.com/powershell/powershell/pull/2850) (Thanks to @powercode!)
- Fix crash when converting a recursive array to a bool. [(#3208)](https://github.com/powershell/powershell/pull/3208) (Thanks to @PetSerAl!)
- Fix casting single element array to a generic collection. [(#3170)](https://github.com/powershell/powershell/pull/3170)
- Allow profile directory creation failures for Service Account scenarios. [(#3244)](https://github.com/powershell/powershell/pull/3244)
- Allow Windows' reserved device names (e.g. CON, PRN, AUX, etc.) to be used on non-Windows platforms. [(#3252)](https://github.com/powershell/powershell/pull/3252)
- Remove duplicate type definitions when reusing an `InitialSessionState` object to create another Runspace. [(#3141)](https://github.com/powershell/powershell/pull/3141)
- Fix `PSModuleInfo.CaptureLocals` to not do `ValidateAttribute` check when capturing existing variables from the caller's scope. [(#3149)](https://github.com/powershell/powershell/pull/3149)
- Fix a race bug in WSMan command plug-in instance close operation. [(#3203)](https://github.com/powershell/powershell/pull/3203)
- Fix a problem where newly mounted volumes aren't available to modules that have already been loaded. [(#3034)](https://github.com/powershell/powershell/pull/3034)
- Remove year from PowerShell copyright banner at start-up. [(#3204)](https://github.com/powershell/powershell/pull/3204) (Thanks to @kwiknick!)
- Fixed spelling for the property name `BiosSerialNumber` for `Get-ComputerInfo`. [(#3167)](https://github.com/powershell/powershell/pull/3167) (Thanks to @iSazonov!)
